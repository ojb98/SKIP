...
const STATUS_FILTER = 'PENDING';
  ...
  function PendingTable() {
    ...
    const loadRents = async () => {
      try {
        const data = await fetchPendingRents();
        if (!Array.isArray(data)) {
          setRents([]);
        } else {
          setRents(data);
    ...
    return (
      <div className="table-container">
        <div style={{ display: 'flex' }}>
          <button onClick={fetchPendingRents} style={{ cursor: 'pointer', border: 'none', background: 'none', display: 'flex', alignItems: 'center', marginBottom:"25px" }}>
            <h3>❓ 승인 대기 목록 조회</h3>
          </button>
        ...
        {selectedRent && (
          <div className="user-detail-card">
            <div className="user-section"> <br /> 
              ...
              <img src={selectedRent.thumbnail ? `${__APP_BASE__}${selectedRent.thumbnail}` : "/images/default-shop.png"} alt="렌탈샵 프로필" />
            ...
            <div style={{borderLeft:"1px solid #dddddd", paddingLeft:"20px"}}>
              ...
              <div style={{display:"flex" }}>
                ...
                />
                <img src={selectedRent.image2 ? `${__APP_BASE__}${selectedRent.image2}` : "/images/default-shop.png"}
                  style={{ width: "150px", height: "150px", margin: "40px", marginTop: "30px" }}
                />
                <img src={selectedRent.image3 ? `${__APP_BASE__}${selectedRent.image3}` : "/images/default-shop.png"}
                  style={{ width: "150px", height: "150px", margin: "40px", marginTop: "30px" }}
                />
              </div>        
              <div>
