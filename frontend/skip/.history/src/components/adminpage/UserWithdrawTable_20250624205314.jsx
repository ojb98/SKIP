        ...
        {selectedRent && (
          <div className="user-detail-card">
            <div className="user-section"> <br /> 
              ...
              <img src={selectedRent.thumbnail {selectedRent.thumbnail ? `http://localhost:8080${selectedRent.thumbnail}` : "/images/default-shop.png"}|| "/images/default-shop.png"} alt="렌탈샵 프로필" />
