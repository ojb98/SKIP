        ...
        <div className="item-detail-wrapper">
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="form-group">
                    ...
                    <select name="category" value={formData.category} onChange={handleFormChange} d>
                    ...
                    <div key={idx} className="form-inline-row">
                        <select name="rentHour" value={tp.rentHour} onChange={e => handleTimePriceChange(idx, e)}>
                            ...
                            {selectedOptions.hours.map((hour) => (
                                <option key={hour} value={hour}>{hour === 8760 ? "1년" : `${hour}시간`}</option>
                            ))}
                        </select>
                ...
                <div style={{ textAlign: "center" }}>
                    <button type="submit" className="item-update-btn">장비 수정</button>
                </div>
            </form>
        </div>
    )
