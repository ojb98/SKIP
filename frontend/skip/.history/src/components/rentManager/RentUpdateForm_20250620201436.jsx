        ...
        <div className="rent-container">
            ...
            <div className="form-container">
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="form-group">
                    <label htmlFor="bizRegNumber" className="block mb-1 font-semibold text-sm text-gray-700">
                        사업자 등록번호
                    </label>
                    <div className="flex items-center gap-2">
                        ...
                        readOnly={bizRegNumberReadonly}
                        placeholder="예: 1234567890"
                        className={`w-full px-3 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                            bizRegNumberReadonly ? 'bg-gray-100 text-gray-500 cursor-not-allowed' : 'bg-white'
                        }`}
                        />
                        <button
                        type="button"
                        onClick={toggleBizRegReadonly}
                        className="p-2 border rounded-md hover:bg-gray-100"
                        title={bizRegNumberReadonly ? "편집 가능하게 하기" : "편집 잠그기"}
                        >
                        {bizRegNumberReadonly ? <Pencil size={18} /> : <Lock size={18} />}
                        </button>
