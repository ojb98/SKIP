    ...
    <div className="skip-cart-modal-backdrop">
      <div className="skip-cart-modal">
        ...
        <div className="skip-cart-modal-buttons">
          ...
          <button onClick={() => onSelect("tosspay.tosstest")}><img src="/public/images/kakaoPay.png" className="kakaopay"/>토스페이</button>
          <button onClick={() => onSelect("smilepay.cnstest25m")}><img src="/public/images/kakaoPay.png" className="kakaopay"/>스마일페이</button>
