...
import { changeEmail, changeNickname, changeUsername, confirmCode, verifyEmail } from "../../api/userApi";
                ...
                content={
                    <>
                        <div className="flex flex-col items-center gap-10 my-10">
                            <img src={profile.image ? `http://localhost:8080/${profile.image}` : "/images/profile_default.png"} className="w-[160px] h-[160px] rounded-full mb-7"></img>
