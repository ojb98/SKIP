...
import { addHyphen, validateConfirmPassword, validateEmail, validatePassword, validateUsername, validateVerificationCode } from "../../utils/validation";
            ...
            <div className="w-[400px]">
                <form className="flex flex-col items-center gap-5" onSubmit={signupHandler}>
                    <div className="w-full flex justify-between mb-5 border-b">
                        ...
                        <SignupStep step={step} setStep={setStep}></SignupStep>
                    </div>
                    
                    {
                        ...
                        &&
                        <>
                            <p className="text-gray-500 text-sm font-[NanumSquare]">가입 형태를 정해주세요.</p>

                            <div className="w-full flex justify-evenly p-5">
                                <label htmlFor="user" className={radio({ className: 'w-25' })}>
                                    <p>개인회원</p>
                                ...
                                <label htmlFor="manager" className={radio({ className: 'w-25' })}>
                                    <p>법인회원</p>
